...
@section('content')
<div class="max-w-sm mx-auto p-6 dark:bg-gray-800 rounded-2xl shadow-md mt-10 text-black">
    <h1 class="text-2xl font-bold mb-6 text-center text-white">Crear nuevo Post</h1>
    ...
    <form action="{{ route('category.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            <label for="poster" class="block text-sm font-medium text-white mb-1">Autor (email)</label>
        ...
        <div class="flex items-center">
            ...
            <label for="habilitated" class="ml-2 block text-sm text-white">Habilitado</label>
        </div>

        <div>
            <label for="content" class="block text-sm font-medium text-white mb-1">Contenido</label>
